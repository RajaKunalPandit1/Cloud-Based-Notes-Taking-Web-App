    ...
    const homeNotLoggedIn = (
        <div className="main-div" >
            ...
            <div className="main-heading--div" >
                <h1 className="main-heading"><span style={{ color: '#0096c7' }} >Cloud</span><span style={{ color: '#48cae4' }} >Docs</span></h1>
            </div>
            ...
            <div className="main-content--div" >
                ...
                <div className="main-content-content--div">
                    ...
                    <p>
                        ...
                        Hey there! This is My Web-Based Notes Taking Application.
                        Just login/SignUp to make creative notes!
                    ...
                    <button className="login-button--sm wnd"
                        onClick={
                            () => {
                                history.push("/signup")
                            }
